export default {
  copy: (yo) => {
    return Promise.all([
      ...
      yo.fs.copy(yo.templatePath('template/shared/_dockerignore'), yo.destinationPath('.dockerignore'), ...yo.context),
      yo.fs.copy(yo.templatePath('template/shared/_editorconfig'), yo.destinationPath('.editorconfig'), ...yo.context),
      yo.fs.copy(yo.templatePath('template/shared/_eslintignore'), yo.destinationPath('.eslintignore'), ...yo.context),
      yo.fs.copy(yo.templatePath('template/shared/_eslintrc'), yo.destinationPath('.eslintrc'), ...yo.context),
      yo.fs.copy(yo.templatePath('template/shared/_gitignore'), yo.destinationPath('.gitignore'), ...yo.context),
